...
ggplot(ca_covid19, aes(x=reorder(pais, -positivos), y=positivos)) +
  ggtitle("Casos positivos de COVID-19 en Centroamerica y DOM") +
  xlab("Pais") + 
...
ggplot(ca_covid19, aes(x=reorder(pais, -recuperados), y=recuperados))+
  ggtitle("Casos recuperados de COVID-19 en Centroamerica y DOM") +
  xlab("Pais") + 
...
ggplot(ca_covid19, aes(x=reorder(pais, -activos), y=activos)) +
  ggtitle("Casos activos de COVID-19 en Centroamerica y DOM") +
  xlab("Pais") + 
  ylab("Casos activos") +  
  geom_col() +
  theme_bw()+
...
ggplot(ca_covid19, aes(x=reorder(pais, -fallecidos), y=fallecidos)) +
  ggtitle("Casos fallecidos de COVID-19 en Centroamerica y DOM") +
  xlab("Pais") + 
